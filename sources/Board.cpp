...
map<City,int> Board::medicines = {{City::Algiers,0},
                        {City::Atlanta,0},
                        {City::Baghdad,0},
                        {City::Bangkok,0},
                        {City::Beijing,0},
...
map<City,int> Board::stations = {{City::Algiers,0},
                        {City::Atlanta,0},
                        {City::Baghdad,0},
                        {City::Bangkok,0},
                        {City::Beijing,0},
...
map<City,Color> Board::city_color={{City::Algiers, Color::Black}
                ...
                bool Board::is_clean(){
                     ...
                     for(map<City,int>::iterator i = dis_level.begin(); i != dis_level.end(); ++i){
                ...
                void Board::remove_cures(){
                    ...
                    for(map<City,int>::iterator i = medicines.begin(); i != medicines.end(); ++i){
                         (*i).second = 0;
                    }
                }
                ...
                void Board::remove_stations(){
                     ...
                     for(map<City,int>::iterator i = stations.begin(); i != stations.end(); ++i){
                         (*i).second = 0;
                    }
